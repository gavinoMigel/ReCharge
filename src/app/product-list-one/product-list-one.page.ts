...
@Component({
  selector: 'app-product-list-one',
  templateUrl: './product-list-one.page.html',
  styleUrls: ['./product-list-one.page.scss'],
})
export class ProductListOnePage implements OnInit, OnDestroy {
  ...
  getProductDetails(index: number): Product {
    const products: Product[] = [
      { name: 'Regular', price: 400.00, image: 'assets/image/monster.png', quantity: 0 },
      { name: 'Regular', price: 136.00, image: 'assets/image/redbull.png', quantity: 0 },
      { name: 'Regular', price: 165.00, image: 'assets/image/rockstar.png', quantity: 0 },
      { name: 'Regular', price: 74.99, image: 'assets/image/milo.png', quantity: 0 }
    ];
